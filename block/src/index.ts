...
export type SequencePropertiesBlockContract = BlockContract;
export type SequencePropertiesBlockOutputs  = BlockOutputs;
export type SequencePropertiesBlockData     = BlockData;
export const SequencePropertiesBlockPointer = BlockPointer;
