...
- Updated dependencies [849d8eb]
  - @platforma-open/milaboratories.sequence-properties.software@1.2.2
...
- 4d59c02: Vectorize the property computation — single-threaded numpy/polars array math replaces per-row BioPython. ~5x faster at 50k clones; output unchanged within the quantized-equal contract (signed-zero canonicalized).
...
- Updated dependencies [4d59c02]
  - @platforma-open/milaboratories.sequence-properties.software@1.2.1
